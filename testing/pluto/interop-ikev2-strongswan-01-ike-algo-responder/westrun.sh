...
../bin/libreswan-up-down.sh ike=aes128-md5-dh19 -I 192.0.1.254 192.0.2.254
../bin/libreswan-up-down.sh ike=aes128-md5-dh20 -I 192.0.1.254 192.0.2.254
../bin/libreswan-up-down.sh ike=aes128-md5-dh21 -I 192.0.1.254 192.0.2.254
...
../bin/libreswan-up-down.sh ike=3des-md5-modp2048 -I 192.0.1.254 192.0.2.254
