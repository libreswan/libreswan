...
sleep 2
docker exec -it $dnamer ../../guestbin/ip-route.sh add default via 192.1.3.254
docker exec -it $dnamee ../../guestbin/ip-route.sh add default via 192.1.2.254
docker exec -it $dnamer ../../guestbin/ip-route.sh
docker exec -it $dnamee ../../guestbin/ip-route.sh
rm -fr OUTPUT
mkdir OUTPUT
