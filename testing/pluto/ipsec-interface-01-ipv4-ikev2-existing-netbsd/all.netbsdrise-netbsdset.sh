# set 01-netbsdset-add-interface.sh

set# ../../guestbin/prep.sh
set# 
set# ifconfig ipsec1 create
set# ifconfig ipsec1 -link2
...
# rise 02-netbsdrise-add-interface.sh

rise# ../../guestbin/prep.sh
rise# 
rise# ifconfig ipsec1 create
rise# ifconfig ipsec1 -link2
...
# rise 04-netbsdrise-ipsec-up.sh
