...
ping -n -q -c 10000 -I  192.0.2.254  198.18.66.254 2>&1 >/dev/null &
ping -n -q -c 10000 -I  192.0.2.251  198.18.66.254 2>&1 >/dev/null &
ping -n -q -c 10000 -I  192.0.22.254  198.18.66.254 2>&1 >/dev/null &
ping -n -q -c 10000 -I  192.0.22.251  198.18.66.254 2>&1 >/dev/null &
ipsec start
