...
../../guestbin/ip-route.sh add 192.0.100.0/24 via 192.1.2.45  dev eth1
../../guestbin/ip-route.sh add 192.0.101.0/24 via 192.1.2.45  dev eth1
../../guestbin/ip-route.sh add 192.0.110.0/24 via 192.1.2.45  dev eth1
../../guestbin/ip-route.sh add 192.0.111.0/24 via 192.1.2.45  dev eth1
