...
../../guestbin/wait-for.sh --match westnet-eastnet-auto -- ipsec trafficstatus
...
ipsec down westnet-eastnet-auto
# give Delete/Notify some time; traffic counters on the new IPsec SA
# should be 0
../../guestbin/wait-for.sh --match 'westnet-eastnet-auto.*inBytes=0' -- ipsec trafficstatus
