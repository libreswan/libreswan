...
../../guestbin/drip-inbound.sh 1 '#3: processed IKE_SA_INIT request'
../../guestbin/wait-for-inbound.sh 4

# WEST: process IKE_AUTH response; establish Child SA

../../guestbin/drip-inbound.sh 3 '#2: initiator established Child SA using #1'

# EAST: process IKE_AUTH request; establish Child SA

../../guestbin/drip-inbound.sh 4 '#4: responder established Child SA using #3'
