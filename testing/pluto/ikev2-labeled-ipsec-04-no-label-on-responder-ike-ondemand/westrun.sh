...
../../guestbin/wait-for-pluto.sh 'processing IKE_AUTH response'
../../guestbin/wait-for-pluto.sh 'IKE_AUTH response rejected Child SA'
../../guestbin/wait-for-pluto.sh 'peer rejected Child SA'
