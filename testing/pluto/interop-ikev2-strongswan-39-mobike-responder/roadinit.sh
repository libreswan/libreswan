...
../../guestbin/ip-route.sh show scope global | grep "192.1.33.254" && ip route del default via 192.1.33.254
...
../../guestbin/ip-route.sh | grep default || ip route add default via 192.1.3.254
