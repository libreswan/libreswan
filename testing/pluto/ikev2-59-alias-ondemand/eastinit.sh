...
ping -n -f -c 100000 -I  192.0.2.254  192.0.3.254 2>&1 >/dev/null &
ping -n -f -c 100000 -I  192.0.2.251  192.0.3.254 2>&1 >/dev/null &
ping -n -f -c 100000 -I  192.0.22.254  192.0.3.254 2>&1 >/dev/null &
ping -n -f -c 100000 -I  192.0.22.251  192.0.3.254 2>&1 >/dev/null &
ipsec start
