...
"eastnet-westnet-ikev2" #2: initiator established Child SA using #1; IPsec transport [2001:db8:1:2::45/128===2001:db8:1:2::23/128] {AH=>0xAHAH <0xAHAH xfrm=HMAC_SHA1_96 IPCOMP=>0xESPESP <0xESPESP DPD=passive}
...
2001:db8:1:2::23 2001:db8:1:2::45 
	...
	diff: N(s)	hard: 28800(s)	soft: 28800(s)
	last: TIMESTAMP	hard: 0(s)	soft: 0(s)
	current: 164(bytes)	hard: 0(bytes)	soft: 0(bytes)
...
2001:db8:1:2::45 2001:db8:1:2::23 
	...
	diff: N(s)	hard: 28800(s)	soft: 28800(s)
	last: TIMESTAMP	hard: 0(s)	soft: 0(s)
	current: 212(bytes)	hard: 0(bytes)	soft: 0(bytes)
	allocated: 2	hard: 0	soft: 0
	sadb_seq=0 pid=PID refcnt=0
