...
../../guestbin/ip-route.sh -4 get to 0.0.0.0
../../guestbin/ip-route.sh -6 get to ::

# gateway

../../guestbin/ip-route.sh -4 get to 192.1.3.254
../../guestbin/ip-route.sh -6 get to 2001:db8:1:3::254

# peer

../../guestbin/ip-route.sh -4 get to 192.1.2.23
../../guestbin/ip-route.sh -6 get to 2001:db8:1:2::23
...
../../guestbin/ip-route.sh -4   add dev eth0       192.1.2.23 via       192.1.3.254 src       192.0.2.1
../../guestbin/ip-route.sh -6   add dev eth0 2001:db8:1:2::23 via 2001:db8:1:3::254 src 2001:db8:0:2::1
../../guestbin/ip-route.sh -4
../../guestbin/ip-route.sh -6
...
../../guestbin/ip-route.sh -4   del dev eth0       192.1.2.23 via       192.1.3.254 src       192.0.2.1
../../guestbin/ip-route.sh -6   del dev eth0 2001:db8:1:2::23 via 2001:db8:1:3::254 src 2001:db8:0:2::1
...
../../guestbin/ip-route.sh -6 del default
../../guestbin/ip-route.sh -6 add default dev eth0 via fe80::1000:ff:fe32:64ba
../../guestbin/ip-route.sh -6
