...
KVM_BSD_BASE_HOST := openbsd-base
KVM_BSD_BASE_DOMAIN = $(addprefix $(KVM_FIRST_PREFIX), $(KVM_BSD_BASE_HOST))
#We install OpenBSD 6.7 but use os-varient as openbsd6.5 as virt install dosen't support 6.7 yet
VIRT_BSD_VARIANT = openbsd6.5
