...
apt-get install -y libnss3-tools libnss3-dev libunbound-dev libldap-dev libcurl4-nss-dev libcap-ng-dev libpam-dev
...
source /source 9p defaults,noauto,trans=virtio,version=9p2000.L 0 0
EOD
