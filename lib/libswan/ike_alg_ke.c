...
const struct kem_desc ike_alg_kem_modp1536 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP1536,
		},
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_modp2048 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP2048,
		},
		.fips.approved = true,
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_modp3072 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP3072,
		},
		.fips.approved = true,
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_modp4096 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP4096,
		},
		.fips.approved = true,
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_modp6144 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP6144,
		},
		.fips.approved = true,
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_modp8192 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_MODP8192,
		},
		.fips.approved = true,
	},
	.nss.modp.base = MODP_GENERATOR,
...
const struct kem_desc ike_alg_kem_curve25519 = {
	.common = {
		...
		.id = {
			...
			[IKEv2_ALG_ID] = IKEv2_KE_CURVE25519,
		},
	},
	.bytes = 32 /* octets */,
...
const struct kem_desc ike_alg_kem_ml_kem_512 = {
	.common = {
		...
		.id = {
			[IKEv1_OAKLEY_ID] = -1,
			[IKEv1_IPSEC_ID] = -1,
			[IKEv2_ALG_ID] = IKEv2_KE_ML_KEM_512,
		},
	},
...
const struct kem_desc ike_alg_kem_ml_kem_768 = {
	.common = {
		...
		.id = {
			[IKEv1_OAKLEY_ID] = -1,
			[IKEv1_IPSEC_ID] = -1,
			[IKEv2_ALG_ID] = IKEv2_KE_ML_KEM_768,
		},
	},
	/* Data Size on Octets on wire */
...
const struct kem_desc ike_alg_kem_ml_kem_1024 = {
	.common = {
		...
		.id = {
			[IKEv1_OAKLEY_ID] = -1,
			[IKEv1_IPSEC_ID] = -1,
			[IKEv2_ALG_ID] = IKEv2_KE_ML_KEM_1024,
		},
	},
	/* Data Size on Octets on wire */
