...
const struct keyword_def ipsec_conf_keywords[] = {
  ...
  { "keyexchange",  kv_conn,  kt_sparse_name,  KNCF_KEYEXCHANGE, &keyexchange_option_names, NULL, },
  { "ikev2",  kv_conn | kv_processed,  kt_sparse_name,  KNCF_IKEv2, &ikev2_option_names, NULL, },
