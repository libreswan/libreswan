...
const struct keyword_def ipsec_conf_keywords_v2[] = {
	...
	{ "auto",           kv_conn | kv_duplicateok, kt_enum,   KBF_AUTO,
	  &kw_auto_list },
	{ "also",           kv_conn,         kt_appendstring, KSCF_ALSO,
	  NOT_ENUM },
	{ "alsoflip",       kv_conn,         kt_string, KSCF_ALSOFLIP,
	  NOT_ENUM },
	...
	{ "policy_label",    kv_conn | kv_auto | kv_alias,         kt_string,
	  KSCF_POLICY_LABEL, NOT_ENUM },	/* obsolete _ */
	{ "policy-label",    kv_conn | kv_auto,         kt_string,
	  KSCF_POLICY_LABEL, NOT_ENUM },
#endif
	...
	{ "modecfgdns1", kv_conn | kv_auto, kt_string, KSCF_MODECFGDNS1,
	  NOT_ENUM },
	{ "modecfgdns2", kv_conn | kv_auto, kt_string, KSCF_MODECFGDNS2,
	  NOT_ENUM },

	{ "modecfgdomain", kv_conn | kv_auto, kt_string, KSCF_MODECFGDOMAIN,
	  NOT_ENUM },
	...
	{ "connalias",      kv_conn | kv_processed | kv_auto | kv_manual,
	  kt_appendstring,   KSCF_CONNALIAS, NOT_ENUM },

	/* attributes of the phase2 policy */
	{ "phase2alg",      kv_conn | kv_auto | kv_manual,  kt_string, KSCF_ESP,
	  NOT_ENUM },
	{ "esp",            kv_conn | kv_auto | kv_manual | kv_alias,
	  kt_string, KSCF_ESP, NOT_ENUM },
