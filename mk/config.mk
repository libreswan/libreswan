...
TRANSFORMS += 's:@FINALINITSYSTEMDIR@:$(FINALINITSYSTEMDIR):g'

FINALEXAMPLEINITSYSTEMDIR ?= $(FINALEXAMPLECONFDIR)/$(INITSYSTEM)
EXAMPLEINITSYSTEMDIR ?= $(DESTDIR)$(FINALEXAMPLEINITSYSTEMDIR)
TRANSFORMS += 's:@FINALEXAMPLEINITSYSTEMDIR@:$(FINALEXAMPLEINITSYSTEMDIR):g'
...
TRANSFORMS += 's:@FINALCONFDDIR@:$(FINALCONFDDIR):g'

FINALEXAMPLECONFDDIR ?= $(FINALEXAMPLECONFDIR)/ipsec.d
EXAMPLECONFDDIR ?= $(DESTDIR)$(FINALEXAMPLECONFDDIR)
TRANSFORMS += 's:@EXAMPLECONFDDIR@:$(FINALEXAMPLECONFDDIR):g'
...
FINALEXAMPLEPAMCONFDIR ?= $(FINALEXAMPLECONFDIR)/pam.d
EXAMPLEPAMCONFDIR ?= $(DESTDIR)$(FINALEXAMPLEPAMCONFDIR)
TRANSFORMS += 's:@EXAMPLEPAMCONFDIR@:$(FINALEXAMPLEPAMCONFDIR):g'
