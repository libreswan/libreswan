...
TRANSFORMS += -e 's:@FINALCONFDDIR@:$(FINALCONFDDIR):g'

FINALEXAMPLECONFDDIR ?= $(FINALEXAMPLECONFDIR)/ipsec.d
EXAMPLECONFDDIR ?= $(DESTDIR)$(FINALEXAMPLECONFDDIR)
TRANSFORMS += -e 's:@EXAMPLECONFDDIR@:$(FINALEXAMPLECONFDDIR):g'
...
TRANSFORMS += -e 's:@PAMCONFDIR@:$(FINALPAMCONFDIR):g'

FINALEXAMPLEPAMCONFDIR ?= $(FINALEXAMPLECONFDIR)/pam.d
EXAMPLEPAMCONFDIR ?= $(DESTDIR)$(FINALEXAMPLEPAMCONFDIR)
TRANSFORMS += -e 's:@EXAMPLEPAMCONFDIR@:$(FINALEXAMPLEPAMCONFDIR):g'
