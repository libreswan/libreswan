...
makes USE_3DES=true  USE_DH23=true USE_DH24=true USE_DH31=true USE_CAMELLIA=true
makes USE_3DES=false USE_DH23=false USE_DH24=false USE_DH31=false USE_CAMELLIA=false
