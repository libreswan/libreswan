...
enum ikev2_trans_type_encr {
	...
	IKEv2_ENCR_CHACHA20_POLY1305 = 28,	/* RFC7634 */
 	IKEv2_ENCR_AES_CCM_8_IIV = 29,			/* RFC 8750 */
 	IKEv2_ENCR_AES_GCM_16_IIV = 30, 		/* RFC 8750 */
 	IKEv2_ENCR_CHACHA20_POLY1305_IIV = 31,		/* RFC 8750 */
 	IKEv2_ENCR_KUZNYECHIK_MGM_KTREE = 32,		/* RFC 9227 */
 	IKEv2_ENCR_MAGMA_MGM_KTREE = 33, 		/* RFC 9227 */
 	IKEv2_ENCR_KUZNYECHIK_MGM_MAC_KTREE = 34, 	/* RFC 9227 */
 	IKEv2_ENCR_MAGMA_MGM_MAC_KTREE = 35, 		/* RFC 9227 */
...
enum ikev2_trans_type_prf {
	...
	IKEv2_PRF_HMAC_STREEBOG_512 = 9,	/* RFC 9385 */
...
#define DIGITAL_SIGNATURE_BLOB_ROOF (DIGITAL_SIGNATURE_MLDSA_IDENTITY_87_BLOB+1)
};
...
/*
 * ML-DSA (FIPS 204, draft-ietf-ipsecme-ikev2-pqc-auth)
 *
 * OID arc: 2.16.840.1.101.3.4.3.{17,18,19}
 */

#define ASN1_MLDSA_IDENTITY_SIZE 13

/* ML-DSA-44: OID 2.16.840.1.101.3.4.3.17 */
#define ASN1_MLDSA_IDENTITY_44_BLOB				\
	0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01,	\
	0x65, 0x03, 0x04, 0x03, 0x11

/* ML-DSA-65: OID 2.16.840.1.101.3.4.3.18 */
#define ASN1_MLDSA_IDENTITY_65_BLOB				\
	0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01,	\
	0x65, 0x03, 0x04, 0x03, 0x12

/* ML-DSA-87: OID 2.16.840.1.101.3.4.3.19 */
#define ASN1_MLDSA_IDENTITY_87_BLOB				\
	0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01,	\
