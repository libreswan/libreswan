...
static const char *const routing_tail[] = {
	...
	[RT_UNROUTED_NEGOTIATION] = "unrouted HOLD",      /* unrouted, but negotiation shunt installed */
	[RT_ROUTED_NEGOTIATION] = "erouted HOLD",         /* routed, and negotiation shunt installed */
	/* fail */
