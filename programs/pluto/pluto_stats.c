...
static void whack_pluto_stat(fd_t whackfd, const struct pluto_stat *stat)
{
 ...
 */
static void enum_stats(fd_t whackfd, enum_names *names, unsigned long start,
...
void show_pluto_stats(fd_t whackfd)
{
