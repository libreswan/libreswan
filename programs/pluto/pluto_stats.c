...
void whack_showstats(const struct whack_message *wm UNUSED, struct show *s)
{
	...
	IKE_ALG_STATS("ikev2.recv.invalidke.using", ke, IKEv2_ALG_ID, pstats_invalidke_recv_u);
	IKE_ALG_STATS("ikev2.recv.invalidke.suggesting", ke, IKEv2_ALG_ID, pstats_invalidke_recv_s);
